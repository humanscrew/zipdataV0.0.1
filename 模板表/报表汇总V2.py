...
success_files_msg = str()
for item in success_files_list:
    success_files_msg = success_files_msg + item +'\n'
pyautogui.alert(text='汇总报表已完成！'+'\n\n'+success_files_msg+'已成功取数！', title='汇总报表确认')